...
(defun key-down (key state mod-key scancode unicode)
  ...
  (case key
    ...
    (:sdl-key-a (move (get-entity 0 :layer :mob) '(-5 0 0)))
    (:sdl-key-d (move (get-entity 0 :layer :mob) '(5 0 0)))
    (:sdl-key-w (move (get-entity 0 :layer :mob) '(0 -5 0)))
    (:sdl-key-s (move (get-entity 0 :layer :mob) '(0 5 0)))))
