...
(defun key-down (key state mod-key scancode unicode)
  ...
  (case key
    ...
    (:sdl-key-w (vector-modify (dtv *e2*) 0 -0.01 0))
    (:sdl-key-s (vector-modify (dtv *e2*) 0 0.01 0))
    (:sdl-key-a (vector-modify (dtv *e2*) -0.01 0 0))
    (:sdl-key-d (vector-modify (dtv *e2*) 0.01 0 0))))
